...
extern "C"
{
	...
	ULONG64 PsGetProcessDebugPort(__in PEPROCESS Process);
	...
	NTSTATUS __fastcall PsReferenceProcessFilePointer(PEPROCESS Process, PFILE_OBJECT* pFileObject);

	NTSTATUS NTAPI KeCapturePersistentThreadState(
		IN PCONTEXT Context,
		IN PKTHREAD Thread,
	...
	__int64 __fastcall PsGetProcessDxgProcess(PEPROCESS a1);

	NTSTATUS NTAPI ZwTraceControl(
